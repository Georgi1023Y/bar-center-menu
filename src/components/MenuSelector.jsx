...
export default function MenuSelector() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-white flex flex-col items-center justify-center text-center px-4 py-10">
      ...
      <h2 className="text-4xl font-bold mb-8 text-gray-800">Избери меню</h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 w-full max-w-md px-10 lg:px-0">
        <Link
          to="/food"
          className="bg-yellow-100 hover:bg-yellow-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl text-xl lg:text-2xl px-6 lg:px-8 py-3.5 lg:py-5 rounded-2xl font-semibold text-gray-800 shadow text-center"
        >
          🍽️ Храна
        </Link>
        ...
        <Link
          to="/drinks"
          className="bg-blue-100 hover:bg-blue-200 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl text-xl lg:text-2xl  px-6 lg:px-8 py-3.5 lg:py-5 rounded-2xl font-semibold text-gray-800 shadow text-center"
        >
          🍷 Напитки
        </Link>
      </div>
